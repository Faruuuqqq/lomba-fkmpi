...
import { Send, Bot, User, Sparkles, BookOpen, Wrench, Copy, ArrowDownToLine, Coins, Brain, AlertCircle, CheckCircle2, RefreshCw } from 'lucide-react';
    ...
    <>
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div className="space-y-2">
                <button
                  ...
                  className="w-full p-4 bg-zinc-50 dark:bg-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700 rounded-lg text-left transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            {grammarResult.issues && grammarResult.issues.length > 0 && (
              <div className="space-y-2">
                ...
                {grammarResult.issues.map((issue: any, idx: number) => (
                  <div key={idx} className="p-3 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg">
      ...
      >
        {isCheckingPlagiarism ? (
          ...
          <div className="space-y-4">
            <div className={`p-4 border rounded-lg ${plagiarismResult.isOriginal
              ...
              <div className="p-4 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg">
                ...
                <div className="space-y-2">
                  {logicMapResult.graphData.nodes?.map((node: any, idx: number) => (
                    <div key={idx} className="p-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded">
